  ...
  return (
    <section>
      ...
      <div className={mplus.className}>
        <p className="my-2 w-80  font-extralight md:w-auto ">Hello! I`m Diego Gutierrez Casallas, a passionate self-taught web developer in search of exciting opportunities to kickstart my professional career in the programming field. I speak Spanish as a native language. <br /><br />I have knowledge in HTML, CSS, and JavaScript, as well as experience using frameworks like React and Next.js to create dynamic and engaging web applications.<br /><br />
