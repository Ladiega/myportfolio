...
export default function SectionTree() {
  return (
    <section className="flex flex-col text-center ">
      ...
      <div className="global-card-container flex justify-center gap-3 ">
        ...
        <div className=" md:flex md:flex-row gap-3 ">
          <div className="card-container  flex flex-col justify-center bg-white w-80 rounded-md ">
            ...
            <div className={mplus.className}>/_next/image
      ...
      <span className=' w-full bg-white h-1 my-20 md:hidden'></span>
